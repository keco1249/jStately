 ...
 * This is used primarily for graphs that will be used in submachine states, where the result of
 * running the "inner" state machine gets used as an input for the "outer" state machine. */
