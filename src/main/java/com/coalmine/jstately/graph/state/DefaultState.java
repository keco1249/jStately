...
/** A basic implementation of State with a getter and setter for its description. The onEnter() and onExit() methods do nothing and can be overridden as needed. */
